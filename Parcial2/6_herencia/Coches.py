...
Metodo Constructor. Este metodo especial se coloca dnetro de la clase y se utiliza para dar un valor a los atributos del objeto al momento de crearlo 
"""
...
class Coches:
    ...
    def __init__(self,color,marca,modelo,valocidad,caballaje,plazas):
      self.color = color
      self.marca = marca
      self.modelo = modelo
    ...
    #En python el encapsulamiento tambien se llama visivilidad y por lo general define como seran los artibutos y metodos es decir publicos o privados 

    #Atrubuto Publico
    publico_atrubuto="soy un atrubito publico"
    #Atrubuto Privado
    ...
    #Para usar un metodo privado es nesesario hacerlo dentro de un metodo publico
    def getMatodoPublico(self):
        self.__getMetodoPrivado()

  #para hacer un atributo privado se tr=endria que hacer dentro metodo que fuera publico el metodo
...
class Camiones(Coches):
  ...
  def __init__(self,color,marca,modelo,velocidad,caballaje,plazas,eje,capacidadCarga):
    ...
    self.__eje=eje
    self.__capacidadCarga=capacidadCarg
  ...
  def setCapacidadCarg(self,CapacidadCarga):
    self.__CapacidadCarga=CapacidadCarga

  def getInfo(self):
    print(f"Marca: {self.getMarca()} {self.getColor()}, numeros de plazas: {self.getPlazas()} \nModelo: {self.getModelo()} con una velocidad de {self.getVelocidad()} Km/h y un potencia de {self.getCaballaje()} hp con {self.getEje()} ejes y na capsacidad de carga de {self.getCapacidadCarga} metros cubicos")    

class Camionetas(Coches):
  def __init__(self, color, marca, modelo, velocidad, caballaje, plazas, eje, capacidadCarga, traccion, cerrada):
    super().__init__(color, marca, modelo, velocidad, caballaje, plazas)
  ...
  def getInfo(self):
    print(f"Marca: {self.getMarca()} {self.getColor()}, numeros de plazas: {self.getPlazas()} \nModelo: {self.getModelo()} con una velocidad de {self.getVelocidad()} Km/h y un potencia de {self.getCaballaje()} hp con {self.getTraccion()} de Traccion y es {self.getCerrada}")  
